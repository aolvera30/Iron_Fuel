...
def calculate_macros(weight_lbs, height_feet, height_inches, age, gender, activity_level, goal):
    try:
        ...
        weight_lbs = float(weight_lbs)  # Ensure weight is a float
        height_feet = int(height_feet)  # Ensure feet is an integer
        height_inches = int(height_inches)  # Ensure inches is an integer
        age = int(age)  # Ensure age is an integer

        # Print for debugging
        print("============================ Input Validation")
        print(f"weight_lbs: {weight_lbs}, height_feet: {height_feet}, height_inches: {height_inches}, age: {age}")
        ...
        print(f"Error in calculate_macros: {e}")
        raise
